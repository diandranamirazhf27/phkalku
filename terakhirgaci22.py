...
# =============== KOTAK SARAN ========================
    ...
    st.markdown("Silahkan tinggalkan saran,kritik,atau pertanyaan anda melalui formulir di bawah ini:")
    ...
    st.markdown("""
        ...
        <form action="https://formsubmit.co/nevisahara2006@gmail.com" method="POST">
            ...
            <!-- Input Pesan -->
            <textarea name="Pesan" placeholder="Tulis pesan Anda di sini..." required 
                      style="width:100%; height:120px; padding:10px; margin-bottom:10px; border-radius:5px; border:1px solid #ccc;"></textarea><br>
    ...
    st.write("Pesan Anda telah berhasil dikirim. kami akan merespon secepatnya.")