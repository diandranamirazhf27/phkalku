...
if jenis == "Asam Kuat":
    st.subheader("Daftar Asam Kuat:")
    for nama in asam_kuat:
        st.write("•", nama)

elif jenis == "Asam Lemah":
    st.subheader("Daftar Asam Lemah:")
    for nama in asam_lemah:
        st.write("•", nama)

elif jenis == "Basa Kuat":
    st.subheader("Daftar Basa Kuat:")
    for nama in basa_kuat:
        st.write("•", nama)

elif jenis == "Basa Lemah":
    st.subheader("Daftar Basa Lemah:")
    for nama in basa_lemah:
        st.write("•", nama)
    ...
    if jenis in ["Asam Lemah", "Basa Lemah", "Custom"]:
        konstanta = st.number_input(f"Masukkan {'Ka' if 'Asam' in jenis else 'Kb'}", min_value=0.0, max_value=14.0, step=1e-8, format="%.2e")
